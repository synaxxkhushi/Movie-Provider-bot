...
BOT_TOKEN = environ.get('BOT_TOKEN', "6867183424:AAHVxITKbP-9hVOBBMn87ABXG6LitaiUqrE")
...
STREAM_API = (environ.get('STREAM_API', '8b61ab6d6ba3af82b1207b0e6c6f064c2d2cb3b8'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/Toutorialbysynax/5'))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6231550362').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002053069822').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002053069822') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002053069822') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002053069822') # request channel id ( make sure bot is admin )
...
DATABASE_NAME = environ.get('DATABASE_NAME', "EXONTESTMONGO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify/token system
VERIFY = bool(environ.get('VERIFY', True)) # Verification On ( True ) / Off ( False )
# HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/Toutorialbysynax/5') 
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/Toutorialbysynax/5') # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Toutorialbysynax/5') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ultroidxTeam')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002053069822')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/synaxchatgroup') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002053069822'))
